...
export default function Timeline() {
  ...
  return (
    <section
      id="timeline"
      className="relative z-10 bg-slate-950/80 pt-20 pb-[150px] overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div className="relative flex flex-col items-center justify-center text-center mt-[150px]">
          ...
          <div className="relative -mt-12 sm:-mt-20 md:-mt-28 max-w-2xl w-full bg-slate-900/90 backdrop-blur-xl border border-cyan-500/40 rounded-xl p-6 shadow-[0_0_30px_rgba(0,240,255,0.15)] text-left font-mono z-4">
      ...
      <div
        ref={scrollRef}
        className="w-full overflow-x-auto pb-8 pt-4 px-4 sm:px-8 cursor-grab active:cursor-grabbing scrollbar-thin scrollbar-thumb-cyan-500/30 scrollbar-track-slate-950 relative z-10"
      >
        <div ref={containerRef} className="flex gap-6 min-w-max mx-auto px-4">
          {timeline.map((item) => (
            <div
              key={item.filename}
              className="w-[320px] sm:w-[420px] md:w-[480px] bg-slate-900/95 border border-slate-800 hover:border-cyan-500/50 rounded-xl overflow-hidden shadow-2xl backdrop-blur-md transition-all duration-300 hover:shadow-[0_0_25px_rgba(0,240,255,0.2)] flex flex-col"
            >
              {/* Code Card Window Header */}
              <div className="flex items-center justify-between px-4 py-3 bg-slate-950/90 border-b border-slate-800 font-mono text-xs text-slate-400">
              ...
              <div className="p-4 overflow-x-auto bg-slate-950/50 flex-grow font-mono text-xs sm:text-sm">
                <pre
